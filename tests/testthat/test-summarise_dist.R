test_that("disturbance_by_season works", {
    ...
    expect_equivalent(names(x1), c("season", "disturbance_cause", "encounter_type", "n"))
})
...
test_that("nest_disturbance_by_season_odkc works", {
    ...
    expect_setequal(names(x2), c("season", "disturbance_cause", "n", "encounter_type"))
})
...
test_that("general_disturbance_by_season_odkc works", {
    ...
    expect_setequal(names(x3), c("season", "disturbance_cause", "n", "encounter_type"))
})
