...
test_that("survey_count filters surveys to site_id and season", {
    ...
    calculated_result <- survey_count(wastd_data$surveys,
                                      one_site_id,
                                      one_season)
...
test_that("survey_ground_covered works", {
    ...
    calculated_result <- survey_ground_covered(wastd_data$surveys,
                                               one_site_id,
                                               beach_kms,
                                               one_season)
...
fs::dir_ls(here::here("tests/testthat/"), glob = "*.png") %>% fs::file_delete()
