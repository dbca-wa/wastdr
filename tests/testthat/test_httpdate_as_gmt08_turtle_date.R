...
test_that("httpdate_as_gmt08_turtle_date returns correct date", {
    ...
    db <- httpdate_as_gmt08_turtle_date("2016-11-20T04:00:00Z") # noon AWST
    dc <- httpdate_as_gmt08_turtle_date("2016-11-21T03:59:59Z") # 1 sec before noon AWST

    testthat::expect_equal(da, nov20)
    testthat::expect_equal(db, nov20)
    testthat::expect_equal(dc, nov20)
})
