...
Send us your [issues](https://github.com/parksandwildlife/wastdr/issues) or
submit a pull request.

Make sure to rebuild the documentation before checking the package.

Pull requests should pass checks (not introduce ERRORs, WARNINGs or NOTEs apart 
from the "New CRAN package" NOTE) and pass all tests:
