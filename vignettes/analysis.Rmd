...
speciesCols <- list(
    "cheloniidae-fam" = "gray",
    "chelonia-mydas" = "green",
    "eretmochelys-imbricata" = "darkblue",
    "natator-depressus" = "beige",
    "corolla-corolla" = "pink",
    "lepidochelys-olivacea" = "darkgreen",
    "caretta-caretta" = "orange"
)

speciesText <- list(
    "cheloniidae-fam" = "Unknown",
    "chelonia-mydas" = "Green",
...
typeText <- list(
    "hatched-nest" = "NH", 
    "successful-crawl" = "N",
    "track-not-assessed" = "T+?",
    "track-unsure" = "N?",
    "nest" = "N",
    "false-crawl" = "T")

mkIcon <- function(nest_type, species) {
    leaflet::makeAwesomeIcon(
        text = nest_type, #typeText[nest_type][[1]],
        markerColor = speciesCols[[species]])
}
...
tracks_map <- function(track_data) {
    ...
    tracks.df <- split(track_data, track_data$species)
