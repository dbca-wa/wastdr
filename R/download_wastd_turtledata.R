...
#' \itemize{
#'   \item downloaded_on An UTC POSIXct timestamp of the data snapshot generated by
#'         \code{\link{Sys.time}}.
#'   \item sites An sf object of known WAStD sites.
#'   \item areas An sf object of known WAStD localities.
#'   \item surveys A tibble of surveys, reconstructed by WAStD from Site Visit Start
...
#'   \item nest_excavations Turtle Nest Excavations - hatching and emergence success
